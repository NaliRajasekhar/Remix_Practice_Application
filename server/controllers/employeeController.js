...
// EmployeeDetails in table on Frontend Dashboard 
...
// Loggin with email and password after verify
...
// Change the current password by putting previous password
...
// sign up with enter fields compulsary
const Signup = async (req, res) => {
   try {
      const { Emp_Name, Phone, DOB, Gender, Email, Password } = req.body;
...
// employee_ salary mapping table------//
// get details from employee and emp_salarie in mapping
...
// creating an new employee and storing the the emp_id in diff tables
...
// delete the employee details from all tables
